...
for (let i = 0; i < miCamino.material.length; i++) {
  const elemento = miCamino.material[i];
  if(i===0){
    console.log(`Lo primero que debo de llevar es ${elemento.nombre} y es ${elemento.descripcion}`);
  } else if (i===1){
    console.log(`Lo segundo que debo llevar es ${elemento.nombre} y es ${elemento.descripcion}`);
  } else if (i===2){
    console.log(`Lo tercero que debo llevar es ${elemento.nombre} y es ${elemento.descripcion}`);
  }else {
    console.log(`Y por último que debo llevar la ${elemento.nombre} y es ${elemento.descripcion}`);
  }
};
...
for (let i = 0; i < miCamino.cimas.length; i++) {
  const picos = miCamino.cimas[i];
    console.log(`Para subir al ${picos.nombre} debo subir ${picos.altitud} metros y debo viajar a ${picos.localizacion}`);
}
